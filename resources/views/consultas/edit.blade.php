            ...
            <form action="{{ route('consultas.update', $consulta->id) }}"
                ...
                <div class="tab-content p-3 shadow-sm">
                    ...
                    <div class="tab-pane fade" id="signos">
                        ...
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                <label>Peso</label>
                                <input type="text" name="peso" class="form-control" value="{{ $consulta->peso }}">
                            </div>

                            <div class="col-md-3 mb-3">
                                <label>Estatura</label>
                                <input type="text" name="estatura" class="form-control" value="{{ $consulta->estatura }}">
                            </div>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="text" name="temperatura" class="form-control" value="{{ $consulta->temperatura }}">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                <label>FC</label>
                                <input type="text" name="frecuencia_cardiaca" class="form-control" value="{{ $consulta->frecuencia_cardiaca }}">
                            </div>

                            <div class="col-md-4 mb-3">
                                <label>FR</label>
                                <input type="text" name="frecuencia_respiratoria" class="form-control" value="{{ $consulta->frecuencia_respiratoria }}">
                            </div>

                            <div class="col-md-4 mb-3">
                                <label>Saturación O₂</label>
                                <input type="text" name="saturacion_o2" class="form-control" value="{{ $consulta->saturacion_o2 }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tab-pane fade" id="diagnostico">
                        ...
                        <textarea name="diagnostico" class="form-control" rows="3">{{ $consulta->diagnostico }}</textarea>

                        <label class="form-label mt-3">Código CIE10</label>
                        <input type="text" name="cie10" class="form-control" value="{{ $consulta->cie10 }}">
                    </div>
                    ...
                    <div class="tab-pane fade" id="tratamiento">
                        ...
                        <textarea name="tratamiento" class="form-control" rows="4">{{ $consulta->tratamiento }}</textarea>
                    </div>
                    ...
                    <div class="tab-pane fade" id="receta">
                        ...
                        <textarea name="receta" class="form-control" rows="6">{{ $consulta->receta }}</textarea>
                    </div>
                    ...
                    <div class="tab-pane fade" id="remision">
                        ...
                        <input type="text" name="hospital_destino" class="form-control mb-3"
                               value="{{ $consulta->hospital_destino }}">

                        <label>Motivo</label>
                        <textarea name="motivo_remision" class="form-control" rows="3">{{ $consulta->motivo_remision }}</textarea>
                    </div>
                    ...
                    <div class="tab-pane fade" id="examenes">
                        ...
                        <input id="inputExamenes"
                               name="examenes"
                               class="form-control"
                               value="{{ $consulta->examenes ? implode(',', $consulta->examenes) : '' }}">
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select name="tipo_pago" class="form-select">
                                    <option {{ $consulta->tipo_pago=='Efectivo'?'selected':'' }}>Efectivo</option>
                                    <option {{ $consulta->tipo_pago=='Tarjeta'?'selected':'' }}>Tarjeta</option>
                                    <option {{ $consulta->tipo_pago=='Transferencia'?'selected':'' }}>Transferencia</option>
                                    <option {{ $consulta->tipo_pago=='Sin Cobro'?'selected':'' }}>Sin Cobro</option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select name="pagado" class="form-select">
                                    <option value="0" {{ !$consulta->pagado ? 'selected':'' }}>Pendiente</option>
                                    <option value="1" {{ $consulta->pagado ? 'selected':'' }}>Pagado</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tab-pane fade" id="archivos">
                        ...
                        @foreach($consulta->archivos as $archivo)
                            <div class="border rounded p-2 mb-2">
                                ...
                                <a href="{{ route('consultas.archivo.delete', $archivo->id) }}"
                                   class="btn btn-danger btn-sm"
                                   onclick="return confirm('¿Eliminar archivo?')">
                                    Eliminar
                                </a>

                                <p class="text-muted mt-1">{{ $archivo->observacion }}</p>
                ...
                <div class="mt-4 text-end">
                    <a href="{{ route('consultas.show', $consulta->id) }}" class="btn btn-secondary">Cancelar</a>
