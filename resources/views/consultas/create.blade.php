...
.nav-tabs .nav-link:not(.active) { background: #f3f3f3; }

.nav-link[href="#motivo"].active { background:#caff9c!important; color:#125c0b!important; }
.nav-link[href="#signos"].active { background:#bde3ff!important; color:#0b3e66!important; }
.nav-link[href="#diagnostico"].active { background:#fff3a8!important; color:#665600!important; }
.nav-link[href="#tratamiento"].active { background:#ffd1df!important; color:#7a0030!important; }
.nav-link[href="#receta"].active { background:#ffe2c4!important; color:#7a3900!important; }
.nav-link[href="#incapacidad"].active { background:#e8d1ff!important; color:#4a007a!important; }
.nav-link[href="#remision"].active { background:#d4fff7!important; color:#00635c!important; }
.nav-link[href="#examenes"].active { background:#ccffe8!important; color:#006644!important; }
.nav-link[href="#pago"].active { background:#ffe8a8!important; color:#6d4e00!important; }
.nav-link[href="#archivos"].active { background:#e6e6e6!important; color:#333!important; }
...
<div class="card shadow-lg" style="border-radius:18px;">
    <div class="card-body">
        ...
        <form action="{{ route('consultas.store', $paciente->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="tab-content p-3 shadow-sm">
                ...
                <div class="tab-pane fade show active" id="motivo">
                    ...
                    <textarea name="motivo" class="form-control" rows="3"
                        placeholder="Descripción breve del motivo por el cual el paciente acude a consulta"></textarea>
                </div>
                ...
                <div class="tab-pane fade" id="diagnostico">
                    ...
                    <textarea name="diagnostico" class="form-control" rows="3"
                        placeholder="Descripción del diagnóstico clínico encontrado"></textarea>

                    <label class="form-label mt-3">Código CIE10</label>
                    <input type="text" name="cie10" class="form-control"
                        placeholder=" J00, A09, M54.5">
                </div>
                ...
                <div class="tab-pane fade" id="tratamiento">
                    ...
                    <textarea name="tratamiento" class="form-control" rows="4"
                        placeholder="Indique tratamiento recomendado o indicaciones médicas"></textarea>
                </div>
                ...
                <div class="tab-pane fade" id="receta">
                    ...
                    <textarea name="receta" class="form-control" rows="6"
                        placeholder="Medicamentos indicados, dosis, frecuencia y vía"></textarea>
                </div>
                ...
                <div class="tab-pane fade" id="remision">
                    ...
                    <input type="text" name="hospital_destino" class="form-control mb-3"
                        placeholder="Nombre del hospital o especialista">

                    <label>Motivo</label>
                    <textarea name="motivo_remision" class="form-control" rows="3"
                        placeholder="Motivo por el cual se remite al paciente"></textarea>
                </div>
                ...
                <div class="tab-pane fade" id="examenes">
                    ...
                    <input id="inputExamenes"
                        name="examenes"
                        class="form-control"
                        placeholder="Ej: Hemograma, Glucosa, Rx Tórax">
                </div>
